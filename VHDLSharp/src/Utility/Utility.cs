...
internal static class Utility
{
    ...
    internal static Dimension GetDimension(this ILogicallyCombinable<ISignal, SignalLogicStringOptions> expression) => expression.BaseObjects.FirstOrDefault()?.Dimension ?? new Dimension();
}