...
//     private readonly Dictionary<ValidityManager2, int> trackedEntityManagers = [];
...
//     public ValidityManager2(IValidityManagedEntity entity, ObservableCollection<object> trackedEntities)
//     {
//         this.entity = entity;
...
//     /// <param name="trackedEntities">Entities being tracked by the main entity. 
//     /// Objects are discarded if they don't implement <see cref="IValidityManagedEntity"/></param>
//     public ValidityManager2(IValidityManagedEntity entity, ObservableCollection<IValidityManagedEntity> trackedEntities)
//     {
//         this.entity = entity;
//         FollowTrackedEntityCollection(trackedEntities);
//     }
...
//     /// </summary>
//     protected ValidityManager2(IValidityManagedEntity entity)
//     {
//         this.entity = entity;
//     }
...
//                 foreach (ValidityManager2 manager in trackedEntityManagers.Keys)
...
// public class ValidityManager2<T> : ValidityManager2 where T : notnull
// {
//     /// <summary>
...
//     public ValidityManager2(IValidityManagedEntity entity, ObservableCollection<T> trackedEntities) : base(entity)
//     {
//         FollowTrackedEntityCollection(trackedEntities);
//     }
// }